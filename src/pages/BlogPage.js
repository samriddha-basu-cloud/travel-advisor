...
const BlogPage = () => {
  return (
    <div className="mt-20 p-4 sm:p-6 lg:p-8 bg-gradient-to-b from-red-100 to-white min-h-screen">
      <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 sm:mb-8 lg:mb-12 text-center text-red-700">Our Blog</h1>
